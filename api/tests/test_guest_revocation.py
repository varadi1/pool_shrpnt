...
class TestGuestRevocation:
    ...
    @pytest.mark.asyncio
    async def test_remove_from_azure_ad_groups_with_retry(self, guest_service, sample_guest, sample_group):
    ...
    @pytest.mark.asyncio
    async def test_remove_from_all_groups(self, guest_service, mock_session, sample_guest, sample_group):
